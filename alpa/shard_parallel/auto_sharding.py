...
def run_auto_sharding_pass(
    ...
    Args:
      ...
      return_mode: The mode of return value.
        ...
        If it is "single", return a single HLO Module proto, whose status is
          SPMD_PARTITIONED.
        If it is "stage_protos", return HLO Module protos of multiple pipeline
          stages, whose statuses are SHARDING_ANNOTATED.
        If it is "stage_and_hook_protos", return HLO Module protos of multiple
          pipeline stages and the hooked hlo sharding. The statuses of the
          returned protos are SHARDING_ANNOTATED.
...
def run_spmd_partitioner_pass(
    ...
    Args:
      xla_computation: The input HLO Module. The status should be
        SHARDING_ANNOTATED.
